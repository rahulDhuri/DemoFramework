...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Rahul Dhuri"
  # s.authors            = { "Rahul Dhuri" => "rdhuri@athenahealth.com" }
  # s.social_media_url   = "http://twitter.com/Rahul Dhuri"
  ...
  s.source       = { :git => "https://github.com/rahulDhuri/DemoFramework.git", :tag => s.version.to_s }
